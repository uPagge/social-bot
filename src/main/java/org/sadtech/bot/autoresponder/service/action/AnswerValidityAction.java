...
public class AnswerValidityAction implements ActionUnit<AnswerValidity, Content> {
    ...
    @Override
    public MainUnit action(AnswerValidity unit, Content content) {
        ...
        if (WORDS_YES.contains(message.toLowerCase())) {
            ...
            if (save.getValue() == null) {
                ...
                BoxAnswer boxAnswer = BoxAnswer.builder().message(save.getKey()).build();
